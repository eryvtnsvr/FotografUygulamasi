...
import com.example.butunleme.databinding.FragmentEtiketekleBinding;
...
public class EtiketekleFragment extends Fragment {

    private FragmentEtiketekleBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentEtiketekleBinding.inflate(inflater,container,false);
                ...
                labelref.whereEqualTo("labelEditText",labelEditText).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful() && task.getResult().size() >0 ){
                            ...
                            labelref.add(new Etiket(labelEditText))
